...
*           Co. J. Korelc  2020           14 Nov 21 11:07:15 *
**************************************************************
User     : Full professional version
Notebook : Intro_AceFEM_2021
...
Total size of C code            : 3661 bytes */
#include "sms.h"
...
{ int intc,nd,i;FILE *SMSFile;
  ...
  es->id.DefaultIntegrationCode=13;
  if(ic==-1){intc=13;} else {intc=ic;};
  es->id.IntCode=intc;
