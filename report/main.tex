...
Inoltre, diversi campioni di osso trabecolare hanno mostrato diverse proprietà meccaniche a seconda della regione dove vengono prelevati. \citep{Keller:1989,Keller:1993}. Questo è segno della risposta dell'osso che, essendo un tessuto vivo, è in continuo rimodellamento. L'aumento delle proprietà do resisitenza a compressione nella parte centrale dell'osso è di fatto un risposta al maggior quota parte di stress verticali trasmessi dalla parte polposa del disco vertebrale rispetto all'adicente regione periferica di anelli fibrosi. 
...
--> scrivi che non avrebbe senso estendere semplicemente l'area
