...
INTRODUZIONE SUGLI EFFETTI DEL CARICO ESTERNO E DEL RIMODELLAMENTO OSSEO

\subsection{Variazione della simmetria}
\label{sec:variazione_simmetria}
\begin{figure*} \label{figurozza} 
	\centering
...
\begin{figure}[bt!] %% preferably at bottom or top of column
	...
	\caption{Variazione di $\mathbb C_{11}$ al variare di $E_m$}\label{fig:var_Ebone}
\end{figure}
